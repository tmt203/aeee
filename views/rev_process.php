						...
						<div class="sj-aboutus">
							...
							<div class="sj-ouraims sj-sectioninnerspace">
								<div class="sj-borderheading">
									<h3>Guidelines for Reviewers</h3>
								</div>
								<div class="sj-ouraim">
									<div class="sj-description">
										<figure class="sj-placeholder sj-alignleft">
											<iframe src="https://www.youtube.com/embed/kVT0FdLCbXU"></iframe>
										...
										<p><a href="http://advances.uniza.sk/pdf/Guideline_for_reviewers_AEEE.exe" target="_blank"><img title="Adobe Captivity" src="http://advances.uniza.sk/OJS/public/site/images/lat04/Adobe_Captivate.png" alt="Adobe_Captivate_35" width="35" height="35" /></a><strong> <span style="text-decoration: underline;"><a href="http://advances.uniza.sk/pdf/Guideline_for_reviewers_AEEE.exe" target="_blank">Flash Animation</a></span></strong> (exe file)</p>
										<!-- <p><iframe width="560" height="315" src="https://www.youtube.com/embed/kVT0FdLCbXU" frameborder="0" allowfullscreen></iframe></p> -->
									</div>
								</div>
							</div>
						</div>
