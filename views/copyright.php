		...
		<div class="row">
			<div class="col-12 col-sm-12 col-md-12 col-lg-12">
				<div class="sj-innerbannercontent">
					<h1>Copyright and Privacy Statements</h1>
						...
						<div class="sj-aboutus">
							...
							<div class="sj-introduction sj-sectioninnerspace">
								...
								<div class="sj-description">
									<p>
									<p>The authors publishing with this Journal agree to the following terms and conditions:</p>
									<ul>
										<li>The authors retain copyright and grant the Journal right of the first publication with the work simultaneously licensed under a <a href="http://creativecommons.org/licenses/by/4.0/" target="_new">Creative Commons Attribution License</a> that allows others to share the work with an acknowledgement of the work's authorship and initial publication in this Journal.</li>
									</ul>
									<ul>
										<li>The authors are able to enter into separate, additional contractual arrangements for the non-exclusive distribution of the Journal's published version of the work (e.g., to post it to an institutional repository or publish it in a book), with an acknowledgement of its initial publication in this Journal.</li>
									</ul>
									<ul>
										<li>The authors are permitted and encouraged to post their work online (e.g., in institutional repositories or on their websites) prior to and during the submission process, as it can lead to productive exchanges, as well as earlier and greater citation of the published work (See <a href="http://opcit.eprints.org/oacitation-biblio.html" target="_new">The Effect of Open Access</a>).</li>
									</ul>
									<ul>
										<li>From the first issue of the 2021 the Creative Commons Attribution License (in our case it´s BY-CC) under which are publishing articles in Advances in Electrical and Electronic Engineering also appear in the full text of all published articles.</li>
									</ul>
									</p>
								</div>
							</div>
							<div class="sj-ourhistory sj-sectioninnerspace">
								...
								<div class="sj-description">
									<p>The Editorial Office provides the names of the reviewers to the author(s) at the express permission of the reviewers only!
									</p>
								</div>
							</div>
						</div>
