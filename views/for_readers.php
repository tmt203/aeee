					...
					<div id="sj-content" class="sj-content">
						<div class="sj-aboutus">
							...
							<div class="sj-introduction sj-sectioninnerspace">
								<span>Advances in Electrical and Electronic Engineering</span>
								<h2>For Readers</h2>
								<div class="sj-description">
									<p>We encourage readers to sign up for the publishing notification service for the Advances in Electrical and Electronic Engineering journal. Use the <a href="http://www.manuscriptmanager.net/aeee">Register</a> link at the top of the homepage. This registration will result in the reader receiving the Table of Contents by email for each new issue. See the Journal's <a href="/copyright.html">Privacy Statement</a> which assures readers that their names and email addresses will not be used for other purposes.</p>
								</div>
							</div>
						</div>
					</div>
